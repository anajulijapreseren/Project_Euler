...
#-----------------------------------------------------------------
#this method is slow so we use one below
# def divisors(n) : 
#     i = 1
#     lis = []
#     while i < n : 
...
#we say all numbers are non abundant and if this isnt true we later change value to zero
# (so they don't make a difference in sum)
